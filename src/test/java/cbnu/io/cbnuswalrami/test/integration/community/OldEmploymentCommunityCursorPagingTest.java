...
@DisplayName("취업정보 게시물 커서페이징(오래뒨순) 통합트스트")
class OldEmploymentCommunityCursorPagingTest extends DatabaseTestBase {
    ...
    public void given_data_15_when_size_1_then_size_1(Long size) {
        ...
        CursorResult cursorResult = oldCommunityCursorPagingService.findEmploymentCommunities(Cursor.from(null, size));
    ...
    public void given_data_size_15_when_find_then_ok() {
        ...
        CursorResult cursorResult1 = oldCommunityCursorPagingService.findEmploymentCommunities(Cursor.from(null, null));
        CursorResult cursorResult2 = oldCommunityCursorPagingService.findEmploymentCommunities(Cursor.from(cursorResult1.getLastIndex(), null));
    ...
    public void given_data_size_15_when_find_then_has_next_false() {
        ...
        // when
        CursorResult cursorResult = oldCommunityCursorPagingService.findEmploymentCommunities(Cursor.from(5L, null));
    ...
    public void given_data_size_15_when_find_then_has_next_true() {
        ...
        // when
        CursorResult cursorResult = oldCommunityCursorPagingService.findEmploymentCommunities(Cursor.from(4L, null));
    ...
    void given_data_size_15_when_find_next_16_then_ex() {
        communityFixture.write15EmploymentCommunity();
        CursorResult cursorResult = oldCommunityCursorPagingService.findEmploymentCommunities(Cursor.from(16L, 10L));
